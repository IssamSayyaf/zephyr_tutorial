...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BUTTON_DRIVER, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BUTTON_DRIVER_LOG_LEVEL_DEFAULT, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BUTTON_DRIVER_LOG_LEVEL, 3);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BUTTON_DRIVER_INIT_PRIORITY, 75);
